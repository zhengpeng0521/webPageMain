import { create, remove, update, query, queryForSearchChannelList,addEssence,clearCache,recommend,doUp,formCreateSubmit,formUpdateSubmit } from '../../services/ChannelMgr/channelMgr';
...
export default {
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        if (location.pathname === '/channel_mgr') {
            dispatch({
  ...
  effects: {
    ...
    *query({ payload }, { call, put, select }) {
        ...
        let channelMgr = yield select(state => state.channelMgr);
