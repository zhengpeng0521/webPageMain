import { create, remove, update, query, queryForSearchChannelList,addEssence,clearCache,recommend,doUp, } from '../../services/UserMgr/topicReport';
...
export default {
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        if (location.pathname === '/user_topic_report') {
            dispatch({
  ...
  effects: {
    ...
    *query({ payload }, { call, put, select }) {
        ...
        let topicReport = yield select(state => state.topicReport);
        let searchData = topicReport.searchData || {};
        let pageIndex = topicReport.pageIndex;
        let pageSize = topicReport.pageSize;
