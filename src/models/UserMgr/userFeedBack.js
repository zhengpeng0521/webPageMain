import { create, remove, update, query, queryForSearchChannelList,addEssence,clearCache,recommend,doUp, } from '../../services/UserMgr/userFeedBack';
...
export default {
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        if (location.pathname === '/user_feedback') {
            dispatch({
  ...
  effects: {
    ...
    *query({ payload }, { call, put, select }) {
        ...
        let userFeedBack = yield select(state => state.userFeedBack);
        let searchData = userFeedBack.searchData || {};
        let pageIndex = userFeedBack.pageIndex;
        let pageSize = userFeedBack.pageSize;
