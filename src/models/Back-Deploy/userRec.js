import { query, queryForSearchChannelList,formCreateSubmit,formUpdateSubmit,remove } from '../../services/Back-Deploy/userRec';
...
export default {
  ...
  effects: {
    ...
    *query({ payload }, { call, put, select }) {
        ...
        let channelMgr = yield select(state => state.userRec);
        ...
        if (ret && ret.errorCode === 9000) {
            ...
            yield put({
              ...
              payload: {
                ...
                formSetData : ret.data.inteligentListURL,
              },
        });
      } else {
    ...
    *'queryForSearchChannelList'({ payload }, { call, put }) {
    ...
    //修改表单提交
    *'formEditSubmit'({ payload }, { call, put, select }) {
      yield put({ type: 'showLoading' });
