import { create, remove, update, query, queryForlList,addEssence,clearCache,recommend,doUp,createFormSubmit,updateFormSubmit } from '../../services/GoldBusiness/secondSale';
...
export default {
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        if (location.pathname === '/second_sale') {
            dispatch({
                type: 'queryForlList'
            });
        }
  ...
  effects: {
    ...
    *query({ payload }, { call, put, select }) {
        ...
        let searchData = secondSale.searchData || {};
