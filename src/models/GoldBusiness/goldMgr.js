import { create, remove, update, query, queryForSearchChannelList,addEssence,clearCache,recommend,doUp,formSubmit } from '../../services/GoldBusiness/goldMgr';
...
export default {
  ...
  effects: {
    ...
    *query({ payload }, { call, put, select }) {
        ...
        let goldMgr = yield select(state => state.goldMgr);
        let searchData = goldMgr.searchData || {};
        let pageIndex = goldMgr.pageIndex;
        let pageSize = goldMgr.pageSize;
