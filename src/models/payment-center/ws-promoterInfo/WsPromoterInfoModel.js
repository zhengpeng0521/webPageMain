...
import { queryPromoterList } from '../../../services/payment-center/ws-promoterInfo/WsPromoterInfoService'
export default {

    namespace: 'WsPromoterInfoModel',
    ...
    subscriptions: {
        setup({ dispatch, history }) {
            history.listen(location => {
                if (location.pathname === '/ws_promoterInfo') {
                    dispatch({
