    ...
    return (
        <div className={styles.TopContent}>
            ...
            <div style={{height:'28px',margin:'10px 0 20px 18px'}}>
                <Radio.Group size="default" value={WeiXinFlyerTopRadioChoose} onChange={WeiXinFlyerChangeTopRadioValue}>
            ...
            <Spin tip="Loading..." spinning={WeiXinFlyerTopBarSpin}>
                <div style={{marginTop:'50px'}}>
                    <ResponsiveContainer width="100%" height={350} >
                        <BarChart
                            data={WeiXinFlyerTopBarContent}
                            barSize={40}
                            ...
                            {
                                WeiXinFlyerTopRadioChoose == 'views' ? <Bar dataKey="浏览数" stackId="a" fill="#b4d5fe" stroke='#666666' strokeWidth=  {1}/> :
                                WeiXinFlyerTopRadioChoose == 'shares' ? <Bar dataKey="分享数" stackId="a" fill="#b4d5fe" stroke='#666666' strokeWidth={1}/> :
                                WeiXinFlyerTopRadioChoose == 'validUsers' ? <Bar dataKey="有效用户数" stackId="a" fill="#b4d5fe" stroke='#666666' strokeWidth={1}/> :
                                WeiXinFlyerTopRadioChoose == 'createNum' ? <Bar dataKey="创建次数" stackId="a" fill="#b4d5fe" stroke='#666666' strokeWidth={1}/> : null
                            }
...
export default WeiXinFlyerTopChart;
