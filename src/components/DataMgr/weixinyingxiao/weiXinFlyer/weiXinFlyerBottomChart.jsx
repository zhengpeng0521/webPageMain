...
function WeiXinFlyerBottomChart({
    ...
    return (
        <div className={styles.BottomContent}>
            ...
            <div style={{height:'28px',margin:'60px 0 20px 20px'}}>
                <Radio.Group size="default" value={WeiXinFlyerBottomLeftRadioChoose} onChange={WeiXinFlyerChangeBottomLeftRadioValue}>
                ...
                <Radio.Group size="default" value={WeiXinFlyerBottomRightRadioChoose} onChange={WeiXinFlyerChangeBottomRightRadioValue} style={{marginLeft:'53px'}}>
                    <Radio.Button value="7">近&nbsp;7&nbsp;日</Radio.Button>
                    <Radio.Button value="30">近30日</Radio.Button>
                </Radio.Group>
            </div>
            <Spin tip="Loading..." spinning={WeiXinFlyerBottomBarSpin}>
                <div style={{textAlign:'center',fontSize:'20px'}}>{WeiXinFlyerBottomBarTitle}&nbsp;({''==WeiXinFlyerChangeBottomRightRadioValue?`${WeiXinFlyerDefinedTime.startTime}~${WeiXinFlyerDefinedTime.endTime}`:`近${WeiXinFlyerChangeBottomRightRadioValue}天`})</div>
                <div style={{marginTop:'20px'}} >
                    <ResponsiveContainer width="100%" height={320} >
                        <LineChart data={WeiXinFlyerBottomBarContent}
...
export default WeiXinFlyerBottomChart;
