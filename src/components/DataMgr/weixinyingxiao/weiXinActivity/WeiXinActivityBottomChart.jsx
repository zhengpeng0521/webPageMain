...
function WeiXinActivityBottomChart({
    ...
    return (
        <div className={styles.BottomContent}>
            ...
            <div style={{height:'28px',margin:'60px 0 20px 20px'}}>
                <Radio.Group size="default" value={WeiXinActivityBottomLeftRadioChoose} onChange={WeiXinActivityChangeBottomLeftRadioValue}>
                ...
                <Radio.Group size="default" value={WeiXinActivityBottomRightRadioChoose} onChange={WeiXinActivityChangeBottomRightRadioValue} style={{marginLeft:'53px'}}>
            ...
            <Spin tip="Loading..." spinning={WeiXinActivityBottomBarSpin}>
                <div style={{textAlign:'center',fontSize:'20px'}}>{WeiXinActivityBottomBarTitle}&nbsp;({''==WeiXinActivityBottomRightRadioChoose?`${WeiXinActivityDefinedTime.startTime}~${WeiXinActivityDefinedTime.endTime}`:`近${WeiXinActivityBottomRightRadioChoose}天`})</div>
                <div style={{marginTop:'20px'}} >
                    <ResponsiveContainer width="100%" height={320} >
                        <LineChart data={WeiXinActivityBottomBarContent}
...
export default WeiXinActivityBottomChart;
