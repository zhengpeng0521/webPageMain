...
function WeiXinActivityTopChart({
    ...
    return (
        <div className={styles.TopContent}>
            ...
            <div style={{height:'28px',margin:'10px 0 20px 18px'}}>
                <Radio.Group size="default" value={WeiXinActivityTopRadioChoose} onChange={WeiXinActivityChangeTopRadioValue}>
            ...
            <Spin tip="Loading..." spinning={WeiXinActivityTopBarSpin}>
                <div style={{marginTop:'50px'}}>
                    <ResponsiveContainer width="100%" height={350} >
                        <BarChart
                            data={WeiXinActivityTopBarContent}
                            barSize={40}
                            minPointSize={3}
                            ...
                            {
                                WeiXinActivityTopRadioChoose == 'views' ? <Bar dataKey="浏览数" stackId="a" fill="#b4d5fe" stroke='#666666' strokeWidth=  {1} unit='次' /> :
                                WeiXinActivityTopRadioChoose == 'shares' ? <Bar dataKey="分享数" stackId="a" fill="#b4d5fe" stroke='#666666' strokeWidth={1} unit='次' /> :
                                WeiXinActivityTopRadioChoose == 'validUsers' ? <Bar dataKey="有效用户数" stackId="a" fill="#b4d5fe" stroke='#666666' strokeWidth={1} unit='个' /> :
                                WeiXinActivityTopRadioChoose == 'createNum' ? <Bar dataKey="创建次数" stackId="a" fill="#b4d5fe" stroke='#666666' strokeWidth={1} unit='次' /> : null
                            }
...
export default WeiXinActivityTopChart;
