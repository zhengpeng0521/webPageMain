...
import style from './WeiXinAppoint.less'


function WeiXinAppointList({
  ...
  const columns = [{
	...
	let paginationProps = {
        current : weiXinAppointPageIndex + 1,
        pageSize : weiXinAppointPageSize,
        total: weiXinAppointTotal,
        showSizeChanger: true,
        showQuickJumper :true,
        onShowSizeChange : changeWeiXinAppointPageSize,
        onChange : changeWeiXinAppointPageIndex,
        showTotal(){
            ...
            <div className="common-over">
                ...
                <div className="common-right" style={{width : '40%'}}>
                    <div className="table-operations" >
                        ...
                        <Button type="primary" onClick={tableOnWeiXinAppointFilter}><Icon type="filter" />筛选</Button>
                    </div>
                </div>
            </div>
            <Table
                columns={columns}
                dataSource={weiXinAppointList}
                loading={weiXinAppointLoading}
                pagination={paginationProps}
                onChange={tablePageChangeWeiXinAppoint}
                bordered
                rowKey="id"
            />
        </div>
...
export default WeiXinAppointList;
