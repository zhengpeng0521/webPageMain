...
const WeiXinOfflineLeafletsAddOrEditModal = ({
    ...
    validateFieldsAndScroll((errors) => {
      ...
      data.id = weiXinOfflineLeafletsFormData.id;
      //删除多余元素
      delete data.zhutu;

      resetFields();
      weiXinOfflineLeafletsFormSubmit(data,weiXinOfflineLeafletsFormType);
    });
  }
    //判断图标
    ...
    //模态框的属性
    let modalOpts = {
    title: weiXinOfflineLeafletsFormType=='create'?'线下传单新增':'线下传单编辑',
    maskClosable : false,
    visible : weiXinOfflineLeafletsFormVisible,
    closable : true,
    width : 585,
    onOk: handleComplete,
    ...
    footer : [
        ...
        <Button key="submit" type="primary" size="large"
                ...
                disabled={weiXinOfflineLeafletsFormLoading}
                loading={weiXinOfflineLeafletsFormLoading}>保存</Button>
    ],
  };

    //编辑图片默认展示
    let urlIcon = weiXinOfflineLeafletsFormData.icon==''||weiXinOfflineLeafletsFormData.icon==null||weiXinOfflineLeafletsFormData.icon==undefined ? null: weiXinOfflineLeafletsFormData.icon;
    let displayImgCover = [{
        uid : -1,
        url : urlIcon,
        name : weiXinOfflineLeafletsFormData.intro,
        thumbUrl : urlIcon,
    }];
            ...
            <Form horizontal>
                ...
                >
                  {getFieldDecorator('title', {
                    initialValue: 'update'!=weiXinOfflineLeafletsFormType?'':
                                  weiXinOfflineLeafletsFormData.title==undefined?'':weiXinOfflineLeafletsFormData.title+'',
                    rules: [
                ...
                >
                  {getFieldDecorator('intro', {
                    initialValue: 'update'!=weiXinOfflineLeafletsFormType?'':
                                  weiXinOfflineLeafletsFormData.intro==undefined?'':weiXinOfflineLeafletsFormData.intro+'',
                    rules: [
                ...
                >
                    {getFieldDecorator('zhutu', {
                        initialValue: 'update'==weiXinOfflineLeafletsFormType?(displayImgCover[0].url!=''&&displayImgCover[0].url!=null&&displayImgCover[0].url!=''!=undefined?displayImgCover:null):null,
                ...
                >
                  {getFieldDecorator('price', {
                    initialValue: 'update'!=weiXinOfflineLeafletsFormType?'':
                                  weiXinOfflineLeafletsFormData.price==undefined?'':weiXinOfflineLeafletsFormData.price+'',
                    rules: [
                ...
                >
                  {getFieldDecorator('previewUrl', {
                    initialValue: 'update'!=weiXinOfflineLeafletsFormType?'':
                                  weiXinOfflineLeafletsFormData.previewUrl==undefined?'':weiXinOfflineLeafletsFormData.previewUrl+'',
                  })(
                ...
                >
                  {getFieldDecorator('defsort', {
                    initialValue: 'update'!=weiXinOfflineLeafletsFormType?'':
                                  weiXinOfflineLeafletsFormData.defsort==undefined?'':weiXinOfflineLeafletsFormData.defsort+'',
                    rules: [
...
export default Form.create()(WeiXinOfflineLeafletsAddOrEditModal);
