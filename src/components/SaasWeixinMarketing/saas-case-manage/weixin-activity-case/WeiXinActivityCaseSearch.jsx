...
import styles from './WeiXinActivityCase.less';

const FormItem = Form.Item;
const Option = Select.Option;
const RangePicker = DatePicker.RangePicker;

const WeiXinActivityCaseSearch = ({
    ...
    let children = [];
    if(weiXinActivityCaseSearchSelectContent && weiXinActivityCaseSearchSelectContent.length > 0){
        children = weiXinActivityCaseSearchSelectContent.map((item) => {
            return(
    ...
    function handleSearchSubmit(e) {
        ...
        validateFields((errors,fieldsValue) => {
            ...
            weiXinActivityCaseSearchSubmit(values);
        });
    }
...
export default Form.create()(WeiXinActivityCaseSearch);
