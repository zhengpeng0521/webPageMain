...
import styles from './WeiXinMarketCase.less';

const FormItem = Form.Item;
const Option = Select.Option;
const RangePicker = DatePicker.RangePicker;

const WeiXinMarketCaseSearch = ({
    ...
    let children = [];
    if(weiXinMarketCaseSearchSelectContent && weiXinMarketCaseSearchSelectContent.length > 0){
        children = weiXinMarketCaseSearchSelectContent.map((item) => {
            return(
    ...
    function handleSearchSubmit(e) {
        ...
        validateFields((errors,fieldsValue) => {
            ...
            weiXinMarketCaseSearchSubmit(values);
        });
    }
...
export default Form.create()(WeiXinMarketCaseSearch);
