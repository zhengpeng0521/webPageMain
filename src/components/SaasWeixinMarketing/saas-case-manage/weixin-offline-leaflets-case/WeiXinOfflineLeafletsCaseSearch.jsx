...
import styles from './WeiXinOfflineLeafletsCase.less';

const FormItem = Form.Item;
const Option = Select.Option;
const RangePicker = DatePicker.RangePicker;

const WeiXinOfflineLeafletsCaseSearch = ({
    weiXinOfflineLeafletsCaseSearchSelectContent,  //微信活动模板名称下拉列表
    ...
    let children = [];
    if(weiXinOfflineLeafletsCaseSearchSelectContent && weiXinOfflineLeafletsCaseSearchSelectContent.length > 0){
        children = weiXinOfflineLeafletsCaseSearchSelectContent.map((item) => {
            return(
    ...
    function handleSearchSubmit(e) {
        ...
        validateFields((errors,fieldsValue) => {
            ...
            weiXinOfflineLeafletsCaseSearchSubmit(values);
        });
    }
    ...
    function handleSearchClear(e) {
        e.preventDefault();
        resetFields();
        weiXinOfflineLeafletsCaseSearchReset();
    }
...
export default Form.create()(WeiXinOfflineLeafletsCaseSearch);
