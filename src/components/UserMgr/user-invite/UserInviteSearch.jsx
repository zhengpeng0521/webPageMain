...
import styles from './UserInvite.less';
        ...
        <div className="search-content">
                ...
                <div className="search-item">
                   {getFieldDecorator('inviter')(
                      <Input placeholder="邀请人ID" style={{ width: 120 }}/>
                    )}
                </div>

                <div className="search-item">
                   {getFieldDecorator('nickname')(
                      <Input placeholder="邀请人昵称" style={{ width: 120 }}/>
                    )}
                </div>

                <div className="search-item">
                   {getFieldDecorator('userId')(
                      <Input placeholder="受邀人ID" style={{ width: 120 }}/>
                    )}
                </div>

                <div className="search-item">
                   {getFieldDecorator('sNickName')(
                      <Input placeholder="受邀人昵称" style={{ width: 120 }}/>
                    )}
                </div>
...
export default Form.create()(UserInviteSearch);
