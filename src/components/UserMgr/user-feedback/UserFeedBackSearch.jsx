    ...
    function handleSearchSubmit(e) {
        ...
        validateFields((errors,fieldsValue) => {
            ...
            if(rangeValueC!=undefined&&rangeValueC.length>0){
                values.createTimeS = rangeValueC[0].format('YYYY-MM-DD');
                values.createTimeE = rangeValueC[1].format('YYYY-MM-DD');
            }
        ...
        <div className="search-content">
            ...
            <div className="search-item">
               {getFieldDecorator('id')(
                  <Input placeholder="反馈ID" style={{ width: 120 }}/>
                )}
            </div>

            <div className="search-item">
                {getFieldDecorator('contactInfo')(
                  <Input placeholder="发表人" style={{ width: 120 }}/>
                )}
            </div>
...
export default Form.create()(UserFeedBackSearch);
