...
const ApplicableActivitiesMgrModal = ({
  ...
  function handleOk(e) {
    ...
    validateFieldsAndScroll((errors) => {
      ...
      if(data.imgurl==''||data.imgurl==null){
        ...
        data.imgurl = data.imgurl.file.url;
      }
  ...
  let modalOpts = {
   ...
   function normFile(e) {
    ...
    let activityTimesInitValue = formData.beginTime && formData.endTime ?
                                [moment(formData.beginTime, dateFormat), moment(formData.endTime, dateFormat)] : undefined
