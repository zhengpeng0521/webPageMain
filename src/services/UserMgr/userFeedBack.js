...
export async function query(params) {
    return serviceRequest(`${BASE_URL}/systemController/adviceList?${qs.stringify(params)}`);
}
...
export async function queryForSearchChannelList(params) {
  return serviceRequest(`${BASE_URL}/systemController/adviceList?pageSize=10&pageIndex=0`);
}
