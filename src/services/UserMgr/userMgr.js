...
export async function query(params) {
    return serviceRequest(`${BASE_URL}/user/allUsers?${qs.stringify(params)}`);
}
...
export async function queryForSearchUser(params) {
  return serviceRequest(`${BASE_URL}/user/allUsers?pageSize=10&pageIndex=0`);
}
